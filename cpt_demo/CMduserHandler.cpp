...
void CMduserHandler::ReqAutenticate()
{
    ...
    strcpy(auField.BrokerID, brokerID);
    strcpy(auField.UserID, uId);
    strcpy(auField.AppID, "simnow_client_test");
    strcpy(auField.AuthCode, "0000000000000000");
}
